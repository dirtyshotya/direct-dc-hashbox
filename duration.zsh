...
MIN_FREQ_FILE="/home/100acresranch/minFreqdurationTh.csv"
MAX_FREQ_FILE="/home/100acresranch/duration.csv"
CONFIG_STEP_FILE="/home/100acresranch/configStepduration.csv"
FREQ_STEP_FILE="/home/100acresranch/freqStepduration.csv"
...
while true; do
    ...
    if (( "$POTENTIAL_FREQUENCY > $MAX_FREQUENCY" )); then
        FREQUENCY=$MAX_FREQUENCY
    elif (( $(echo "$POTENTIAL_FREQUENCY < $MIN_FREQUENCY" | bc -l) )); then
    ...
    sleep 30 # Wait before next measurement
done
